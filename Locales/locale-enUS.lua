...
L["WARNING.NOFAVORITEFACTIONS"] = "Favorite factions can be added or removed using Reputation menu or standard Reputation window"
L["HELP.FAVORITEFACTIONS"] = "You do not have any favorite factions selected"
